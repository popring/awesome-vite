...
- [vite-react-file-routing-template](https://github.com/your-username/vite-react-file-routing-starter) - Starter template with `React 19`, `TypeScript`, `Vite + Rolldown`, file-based routing with `vite-plugin-pages`, `Tailwind CSS v4`, `React Compiler`, and `ESLint`.
